...
public class Histogram { public static void main(String[] args) {
    ...
    //1. Прочетем n на брой числа - трябва потребителя да ни каже колко числа да прочетем
    //1.1 Трябва да направим променливи за всички интервали -> бройката числа за определен интервал
    //1.2 Правим for loop n на брой повторения
    //2. Прочитаме число
    //3. Проверяваме в кой диапазон е числото
    //4. Пресметнем процента за всеки диапазон
    //5. Принтираме
